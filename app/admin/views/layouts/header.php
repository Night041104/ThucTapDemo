...
<head>
    ...
    <style>
        :root {
            ...
            --light-bg: #f3f4f6;
            --text-gray: #9ca3af;
            --active-glow: 0 0 15px rgba(56, 189, 248, 0.3);
        }
        ...
        /* PARENT MENU ITEM (DROPDOWN TRIGGER) */
        .nav-link {
            color: var(--text-gray);
            padding: 14px 20px;
        ...
        body.sidebar-toggled .arrow-icon { display: none; }
        ...
        @media (max-width: 768px) {
            ...
            body.sidebar-toggled .sidebar { width: var(--sidebar-width); transform: translateX(-100%); }
        }
    </style>
</head>
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <a href="index.php?module=admin&controller=dashboard" class="sidebar-brand">
            ...
            <div class="collapse <?= $isOverview ? 'show' : '' ?>" id="collapseOverview">
                <div class="collapse-inner">
                    <a class="collapse-item <?= ($ctrl == 'dashboard') ? 'active' : '' ?>" 
                       href="index.php?module=admin&controller=dashboard">
                       Dashboard
                    </a>
                </div>
            </div>
            ...
            <div class="collapse <?= $isMgmt ? 'show' : '' ?>" id="collapseMgmt">
                <div class="collapse-inner">
                    ...
                    <a class="collapse-item <?= ($ctrl == 'order') ? 'active' : '' ?>" 
                       href="index.php?module=admin&controller=order&action=index">
